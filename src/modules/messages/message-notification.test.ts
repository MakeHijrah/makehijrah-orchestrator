...
const testEnv: Record<string, string> = {
  ...
  STRIPE_TEST_SECRET_KEY: "sk_test_message_notification",
  STRIPE_TEST_WEBHOOK_SECRET: "whsec_test_message_notification",
  STRIPE_LIVE_SECRET_KEY: "sk_live_message_notification",
  STRIPE_LIVE_WEBHOOK_SECRET: "whsec_live_message_notification",
